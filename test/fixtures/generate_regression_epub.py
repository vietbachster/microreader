...
def ch_nested_font_size():
    ...
    return make_xhtml("Nested Font Size", """\
...
def ch_style_nesting():
    ...
    return make_xhtml("Style Nesting", """\
...
def ch_nested_margins():
    ...
    return make_xhtml("Nested Margins", """\
...
def ch_hr():
    ...
    return make_xhtml("HR and Page Breaks", """\
...
def ch_small_sub_sup():
    ...
    return make_xhtml("Small / Sub / Sup", """\
...
def ch_hidden():
    ...
    return make_xhtml("Hidden Elements", """\
...
def ch_css_bold_italic():
    ...
    return make_xhtml("CSS Bold/Italic", """\
...
def ch_images_large():
    ...
    return make_xhtml("Large Images", """\
...
def ch_images_small():
    ...
    return make_xhtml("Small Images", """\
...
def ch_empty_elements():
    ...
    return make_xhtml("Empty Elements", """\
...
def ch_margin_shorthand():
    ...
    return make_xhtml("Margin Shorthand", """\
...
def ch_page_break_after():
    ...
    return make_xhtml("Page Break After", """\
...
def ch_text_transform():
    ...
    return make_xhtml("Text Transform", """\
...
def ch_vertical_margins():
    ...
    return make_xhtml("Vertical Margins", """\
...
def ch_preformatted():
    ...
    return make_xhtml("Preformatted Text", """\
...
def ch_inline_float_images():
    ...
    return make_xhtml("Inline Float Images", """\
...
def ch_inline_whitespace():
    ...
    return make_xhtml("Inline Whitespace", """\
...
def ch_punctuation_after_style():
    ...
    return make_xhtml("Punctuation After Style", """\
...
def ch_br_whitespace():
    ...
    return make_xhtml("BR Whitespace", """\
...
def ch_standalone_br_spacing():
    ...
    return make_xhtml("Standalone BR Spacing", """\
...
def ch_nested_lists():
    ...
    return make_xhtml("Nested Lists", """\
...
def ch_ol_start():
    ...
    return make_xhtml("OL Start Attribute", """\
...
def ch_figure_figcaption():
    ...
    return make_xhtml("Figure & Figcaption", """\
...
def main():
    chapters = [
        ...
        ("ch04", "ch04_nested_font.xhtml",    "4. Nested Font Size",       ch_nested_font_size()),
        ...
        ("ch12", "ch12_small_sub_sup.xhtml",  "12. small / sub / sup",     ch_small_sub_sup()),
        ...
        ("ch17", "ch17_css_bold_italic.xhtml", "17. CSS Bold/Italic",      ch_css_bold_italic()),
        ...
        ("ch26", "ch26_margin_short.xhtml",   "26. Margin Shorthand",      ch_margin_shorthand()),
        ("ch27", "ch27_break_after.xhtml",    "27. Page Break After",      ch_page_break_after()),
        ("ch28", "ch28_text_transform.xhtml", "28. Text Transform",        ch_text_transform()),
        ("ch29", "ch29_blockquote.xhtml",     "29. Blockquote & DL",       ch_blockquote()),
        ("ch30", "ch30_vert_margins.xhtml",  "30. Vertical Margins",      ch_vertical_margins()),
        ("ch31", "ch31_preformatted.xhtml",  "31. Preformatted Text",     ch_preformatted()),
        ("ch32", "ch32_inline_floats.xhtml", "32. Inline Float Images",   ch_inline_float_images()),
        ("ch33", "ch33_inline_ws.xhtml",     "33. Inline Whitespace",     ch_inline_whitespace()),
        ("ch34", "ch34_punct_style.xhtml",   "34. Punctuation After Style", ch_punctuation_after_style()),
        ("ch35", "ch35_br_ws.xhtml",         "35. BR Whitespace",         ch_br_whitespace()),
        ("ch36", "ch36_br_spacing.xhtml",    "36. Standalone BR Spacing", ch_standalone_br_spacing()),
